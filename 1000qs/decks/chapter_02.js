...
export const chapter02 = [
  {
    ...
    "stem": "A major difference between the adult and neonatal airway is that the",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Pierre Robin is a congenital syndrome associated with enlarged tongue, small mouth, and mandibular anomalies typically manifested as micrognathia. All of these limit the oropharyngeal space, contributing to airway obstruction between the tongue and posterior pharyngeal wall. When you see Pierre Robin, think PR: Posterior Restriction behind the tongue."
  },
  {
    "id": 4,
    "chapter": 2,
    "chapterTitle": "Airway Management",
    "stem": "Airway management in Klippel–Feil syndrome is most likely to be challenging because of",
    "options": {
      "A": "Micrognathia",
      "B": "Macroglossia",
    ...
    "correctAnswer": "D",
    "explanation": "Klippel–Feil is a congenital syndrome associated with the phenotypical triad of short neck, low posterior hair line, and congenital spinal fusion causing limited neck mobility. Fused segments of the cervical spine in patients with this syndrome promote hypermobility at unfused spine segments, increasing the risk of neurologic compromise during neck manipulation. When you see Klippel–Feil, think KF: Cervical Fusion."
  },
  {
    "id": 5,
    "chapter": 2,
    "chapterTitle": "Airway Management",
    "stem": "One of the following statements regarding airway management in patients with congenital syndromes is most accurate:",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "The scenario describes extubation of a child during a “light” plane of anesthesia when laryngeal reflexes are hypersensitive. Return of a gag reflex is a characteristic of this lighter, hyperexcitable stage. If a patient is extubated while lightly anesthetized, there is an increased risk of laryngospasm. Stimulation of the laryngeal mucosa by secretions or a foreign body (e.g., the endotracheal tube or an oral airway) can result in laryngospasm during the excitation stage of anesthesia or sometimes even during awake states. Laryngospasm and other causes of upper airway obstruction (e.g., tongue collapsed against the posterior pharyngeal wall) may not be immediately distinguishable. However, the initial treatment is identical: anterior displacement of the mandible using a chin lift or jaw thrust combined with positive-pressure ventilation. If these measures fail to relieve the laryngospasm and hypoxemia develops, pharmacologic therapy should be initiated emergently. In a patient with no contraindications, a small dose of succinylcholine (0.25–0.5 mg/kg) or deepening of the anesthetic (e.g., with propofol or another general anesthetic) should break the laryngospasm."
  },
  {
    "id": 10,
    "chapter": 2,
    "chapterTitle": "Airway Management",
    "stem": "In the scenario above, if the patient’s postextubation condition is left untreated, the patient will most likely experience",
    "options": {
      "A": "Aspiration",
      "B": "Bronchospasm",
      "C": "Pulmonary edema",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "A commonly used formula for estimating the internal diameter of an uncuffed endotracheal tube in children is Internal diameter (in mm) = (Age + 16)/4 The resulting value should be reduced by 0.5 mm when using a cuffed endotracheal tube to allow space in the tracheal lumen for cuff inflation. Since this child appears to have a height and weight appropriate for her age, the formula would be reasonable to use. For the patient in this question, the internal diameter is (2 + 16)/4 = 4.5 mm for an uncuffed tube, which is reduced to 4.0 mm for a cuffed tube."
  },
  {
    "id": 12,
    "chapter": 2,
    "chapterTitle": "Airway Management",
    "stem": "The superior surface of the epiglottis is innervated by the",
    "options": {
      "A": "Hypoglossal nerve",
  ...
  },
  {
    ...
    "chapter": 2,
    "chapterTitle": "Airway Management",
    "stem": "Tactile sensation from the anterior third of the tongue is carried by fibers of the",
    "options": {
      "A": "Trigeminal nerve",
      "B": "Facial nerve",
  ...
  },
  {
    ...
    "chapter": 2,
    "chapterTitle": "Airway Management",
    "stem": "A patient who suffers acute, bilateral denervation of the external branch of the superior laryngeal nerve will most likely present with",
    "options": {
      "A": "No symptoms",
      "B": "Hoarseness",
      "C": "Stridor",
  ...
  },
  {
    ...
    "chapter": 2,
    "chapterTitle": "Airway Management",
    "stem": "The efferent limb of the glottic closure reflex, which is involved in laryngospasm, primarily involves the",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "The ASA Difficult Airway Algorithm recommends use of supraglottic devices such as the laryngeal mask airway (LMA) as rescue tools when laryngoscopy and mask ventilation are unsuccessful. Although the patient in choice A ideally would be treated with “full stomach” precautions, if a rapid sequence induction and intubation are unsuccessful, an LMA may be a life-saving tool to oxygenate and ventilate the patient. Aside from its use as a rescue device, the LMA can be used as a supraglottic airway for elective surgery. Relative contraindications to the elective use of the LMA include low airway compliance (choices B and C), incompetence of the gastroesophageal sphincter (choice C), and in patients with a full stomach (choice D)."
  },
  {
    "id": 28,
    "chapter": 2,
    "chapterTitle": "Airway Management",
    "stem": "After undergoing an uneventful operation, one of the following patients would be the best candidate for “deep extubation”:",
    "options": {
