...
export const chapter06 = [
  {
    ...
    "stem": "Correct statement about metabolism of drugs by the liver is",
    "options": {
    ...
    "correctAnswer": "D",
    "explanation": "Clearance of drugs that are mainly metabolized in the liver is a function of the amount of drug brought into the liver by its blood flow multiplied by ability of the hepatocytes to clear the blood of that drug. For drugs that have a high extraction ratio, the liver removes the entire drug entering the liver in one pass. Lidocaine and propranolol are examples of this kind of clearance. Alfentanil, on the other hand, has a low extraction ratio, and liver blood flow does not really affect its clearance. Instead, it is the intrinsic ability of the liver to clear the blood of this drug that determines alfentanil’s clearance. Cytochrome P450 system can metabolize a wide variety of drugs by a single group of enzymes."
  },
  {
    "id": 2,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "When asked to describe the symptoms of her allergy to a local anesthetic that a 26-year-old female had at the dentist’s office, the patient describes a feeling of light-headedness, palpitations, and flushing. This reaction is most likely caused by",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Effect of sympathomimetic drugs on the mean arterial blood pressure is mediated through their effect on the adrenergic receptors they stimulate. Ultimate effect is generated through complex interaction of different factors based on baseline sympathetic tone, patient’s volume status, and condition of the heart. Although isoproterenol increases contractility through its action on β2 receptors, it also stimulates β1 receptors in big vascular beds like muscle, causing vasodilatation and decreasing the systemic vascular resistance. So despite increasing contractility of the heart and increasing the cardiac output, the mean arterial blood pressure can decrease with administration of this drug. Other medications increase the mean arterial blood pressure by their effect on α1 and β1 receptors."
  },
  {
    "id": 4,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "All of the following drugs increase cardiac output, except",
    "options": {
      "A": "Dopamine",
      "B": "Epinephrine",
      "C": "Dobutamine",
    ...
    "correctAnswer": "D",
    "explanation": "All of these catecholamines cause stimulation of β1 receptors, thus increasing cardiac contractility, but norepinephrine also has a very strong effect on α1 receptors, thus increasing afterload to such a degree that cardiac output may actually decrease after administration of this drug. Cardiac output = Systemic blood pressure/Systemic vascular resistance According to this formula, systemic vascular resistance (SVR) is inversely related to cardiac output; thus, an increase in the SVR may decrease the cardiac output. Other drugs have more effect on cardiac contractility than on SVR, and thus, cardiac output increases with their administration."
  },
  {
    "id": 5,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "In general, norepinephrine causes increase in all of the following, except",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Etomidate actually causes a decrease in the seizure threshold, and is thus useful in cases of electroconvulsive therapy for severe depression. Spontaneous movements characterized as myoclonus occur in more than 50% of patients receiving etomidate and may be associated with seizure- like activity on the EEG. Another side effect is an increased incidence of nausea and vomiting in the postoperative period. It does not cause histamine release in contrast to thiopental, which has been shown to release histamine in vitro."
  },
  {
    "id": 10,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Compared with propofol, ketamine causes",
    "options": {
  ...
  },
  {
    ...
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "True statement regarding flumazenil is",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Cocaine inhibits reuptake of catecholamines into preganglionic nerve terminal; it has a sympathomimetic effect, causing tachycardia, hypertension, pupillary dilatation, and increased skin temperature. Chronic use may lead to cardiomyopathy and depletion of catecholamine stores with unpredictable manifestations during anesthesia."
  },
  {
    "id": 16,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following local anesthetics is an ester?",
    "options": {
      "A": "Lidocaine",
      "B": "Prilocaine",
      "C": "Mepivacaine",
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Ropivacaine is less lipid soluble, and thus less potent than bupivacaine. For a given dose, the sensory block is more than the motor block. Part of the reason ropivacaine may be less cardio toxic than bupivacaine is that it causes vasoconstriction in the tissues, thus decreasing the rate of absorption into systemic circulation. Enantiomers are stereoisomers that exist as mirror images. Enantiomers have identical physical properties except for the direction of the rotation of the plane of the polarized light. Ropivacaine is an S-enantiomer of mepivacaine and bupivacaine."
  },
  {
    "id": 18,
    "chapter": 6,
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Local anesthetics exert their electrophysiologic effects by blocking sodium ion conductance. This effect is primarily mediated by interaction with specific receptors that are within the inner vestibule of the sodium ion channel."
  },
  {
    "id": 20,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Local anesthetics cause their effects by",
    "options": {
    ...
    "correctAnswer": "D",
    "explanation": "Local anesthetics decrease the rate of depolarization of the cell membrane when a nerve impulse arrives and changes the resting membrane potential of the neuron. Normally, this potential is −90 mV inside the cell. When an impulse reaches the cell, it increases the inflow of sodium into the cell, causing this potential to move toward a positive value. If this change is enough to reach a critical level called the threshold potential, an action potential is generated; otherwise, the impulse dies down. Local anesthetics decrease the rate of change of this potential so that it does not reach the threshold level. They do not change the threshold potential or resting membrane potential per se."
  },
  {
    "id": 21,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Lipid solubility of local anesthetics",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Frequent attempts at aspiration are recommended whenever large dose and volume of local anesthetic is injected for epidural or peripheral nerve block to avoid injecting the local anesthetic in the vascular or intrathecal space. Cases of local anesthetic toxicity have been reported even when aspiration was negative for blood or CSF. Addition of a dilute concentration of epinephrine to local anesthetic is helpful as it may alert the practitioner to inadvertent vascular injection of the local anesthetic by increase in the heart rate. It also helps delay the systemic absorption of local anesthetic, thus keeping the maximum serum concentration lower. It is possible that loss of consciousness is secondary to cardiac arrest, but it may also be secondary to high-dose CNS toxicity, respiratory arrest, or high neuraxial anesthesia. Amiodarone was the drug of choice to treat cardiovascular toxicity of bupivacaine in the past, but now 20% intralipid has replaced this drug. Recommended dosage for cardiovascular collapse secondary to bupivacaine toxicity is 1.5 mL/kg bolus, followed by 0.25mL/kg/min for the next 10 minutes. Oxygenation, ventilation, and good basic and advanced life support are extremely essential as bupivacaine toxicity is adversely affected by hypercarbia, acidosis, and hypoxia."
  },
  {
    "id": 27,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "During induction of anesthesia for cesarean delivery in a 22-year-old female, rocuronium is inadvertently substituted for succinylcholine. The neonate does not show any sign of muscle relaxation because rocuronium is",
    "options": {
  ...
  },
  {
    ...
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "All of the following can lead to hyperkalemic response to the administration of succinylcholine, except",
    "options": {
      "A": "Burn injury",
    ...
    "correctAnswer": "D",
    "explanation": "Any time prolonged skeletal muscle inactivity or extensive muscle damage exists, patient may be susceptible to hyperkalemia after the administration of succinylcholine and is dependent on development of extrajunctional atypical receptors. In some patients, potassium levels may exceed 10 mEq/L. This can lead to serious cardiac arrhythmias and even cardiac arrest. The duration of susceptibility to the hyperkalemic response to succinylcholine is unknown but probably decreases after 3 to 6 months of denervation injury. Although cerebral palsy seems to be a muscular problem, consensus is that it is safe to use succinylcholine for these patients if airway management will be facilitated by its use."
  },
  {
    "id": 29,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "The dibucaine number in a patient having heterozygous type of plasma cholinesterase will be",
    "options": {
      "A": "20% to 30%",
      "B": "30% to 40%",
      "C": "60% to 80%",
    ...
    "correctAnswer": "B",
    "explanation": "Atypical plasma cholinesterase lacks the ability to hydrolyze ester bonds in drugs such as succinylcholine and remifentanil. Diagnosis of presence of atypical enzyme can be made by measuring the ability of dibucaine, a local anesthetic, to inhibit the activity of this enzyme. A normal enzyme gets inhibited the most (80%), while atypical homozygous type is minimally inhibited (20%). Heterozygous variety has lesser inhibition. In clinical terms, this leads to prolonged paralysis following administration of succinylcholine, with duration ranging from 5 to 10 minutes with normal enzyme to 60 to180 minutes for patients having homozygous atypical variety of enzyme."
  },
  {
    "id": 30,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following muscle relaxants is eliminated mostly by the kidneys?",
    "options": {
      "A": "Rocuronium",
      "B": "Succinylcholine",
      "C": "Vecuronium",
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Administration of anticholinesterase agent leads to accumulation of acetylcholine, manifesting increased cholinergic actions in the body. Vagal stimulation causes bradycardia and, if not antagonized by concomitant administration of a cholinergic agent, may lead to cardiac standstill. Antisialagogue actions of these agents are also helpful in reducing the excessive salivation induced by parasympathetic overactivity of acetylcholine generated by inhibition of cholinesterase. Disruption of gastrointestinal anastomosis is another consideration, secondary to increased peristalsis of the bowel. Cholinergic activity may also lead to bronchospasm and not bronchodilation."
  },
  {
    "id": 34,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following characteristics of electrical stimulation is the correct representation of the stimulus generated by the nerve stimulator used for monitoring the neuromuscular blockade?",
    "options": {
  ...
  },
  {
    ...
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Mechanism of action of droperidol involves antagonism at all of the following receptors, except",
    "options": {
      "A": "Serotonin",
      "B": "Dopamine",
      "C": "α-Adrenergic",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Dopamine is a major neurotransmitter in extrapyramidal system. Drugs that antagonize dopamine and are able to cross the blood–brain barrier may lead to extrapyramidal symptoms, which may manifest as torticollis, oculogyric crisis, and agitation. List of drugs that can precipitate these symptoms is long, but important ones in the perioperative period are droperidol, metoclopramide, haloperidol, and promethazine. Fortunately, it is readily treated by administration of diphenhydramine. Midazolam is also helpful in treating this condition. Famotidine and glycopyrrolate are not associated with any extrapyramidal effects."
  },
  {
    "id": 40,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following medications should be discontinued before the elective surgery?",
    "options": {
      "A": "Metoprolol",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Patients with hypertrophic cardiomyopathy behave as if they have aortic stenosis except that the left-ventricular outflow obstruction is dynamic instead of being fixed. Decreased afterload under general anesthesia causes the gradient between the left-ventricular pressure and the aortic pressure to increase, leading to collapse of the left-ventricular outflow tract, increasing the obstruction, and decreasing the cardiac output. Restoration of the afterload with administration of phenylephrine reverses this effect. It also decreases the heart rate, allowing more time for left- ventricular perfusion to take place during the diastole. Decreasing the cardiac contractility may also be helpful as that will prevent the opposing walls of the outflow tract to come together relieving the obstruction. Amrinone will actually increase the contractility while reducing the afterload: both effects being undesirable in this clinical situation. Ephedrine will increase the heart rate as well as cardiac contractility, thus making the situation worse as described above. Nitroglycerine may worsen the hypotension and may not be a good choice for a hypotensive patient."
  },
  {
    "id": 46,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Factors that contraindicate ketorolac administration include all of the following except",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "As the clinical situation seems to indicate the need for an agent that is potent and extremely fast in its onset of action, nitroglycerine will be more helpful in this situation. Nitroglycerine is converted into nitric oxide, which is a very potent vasodilator increasing the venous capacitance. This action of nitroglycerine helps relocate the intravascular volume into peripheral compartment, thus unloading the central compartment and allowing the pulmonary edema fluid to be reabsorbed into the circulation."
  },
  {
    "id": 48,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "A 22-year-old college athlete with a history of prolonged QT syndrome presents for an inguinal hernia repair. Which of the following agents would be least likely to further lengthen the QT interval?",
    "options": {
      "A": "Ondansetron",
      "B": "Metoclopramide",
      "C": "Succinylcholine",
  ...
  },
  {
    ...
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following drugs is most likely to cause tachycardia?",
    "options": {
      "A": "Fentanyl",
      "B": "Meperidine",
      "C": "Morphine",
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Opioid receptors are found inside substantia gelatinosa in the spinal cord. Addition of fentanyl to local anesthetic injected in the epidural space decreases the onset of analgesia time. Since epidural bupivacaine has a longer duration of action than epidural fentanyl, the duration of block may not be prolonged. Epidural fentanyl has no effect on the vagus nerve. Degree of analgesia is enhanced by addition of fentanyl to epidural local anesthetic, but the effect on the sensory and motor block is not augmented."
  },
  {
    "id": 52,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Compared with sufentanil, alfentanil is characterized by",
    "options": {
      "A": "Higher pKa",
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Lorazepam is conjugated in the liver with glucuronic acid to produce inactive metabolites, but this process is much slower than the metabolism of midazolam. As a result, the elimination half-life of lorazepam is much longer (10–20 hours) compared with midazolam (1–4 hours). Similarly, the clearance of midazolam is six to eight times that of lorazepam. Volume of distribution of lorazepam is comparable to midazolam."
  },
  {
    "id": 58,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "The drug that causes dose-dependent EEG evidence of both central nervous system excitation and depression is",
    "options": {
      "A": "Thiopental",
      "B": "Lidocaine",
      "C": "Isoflurane",
  ...
  },
  {
    ...
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "A 28-year-old burn patient needs daily wound debridement. Which of the following agents is not appropriate to provide a short duration of anesthesia?",
    "options": {
      "A": "Nitrous oxide",
      "B": "Ketamine",
      "C": "Etomidate",
    ...
    "correctAnswer": "C",
    "explanation": "All of the agents mentioned in this question can be used to anesthetize a patient for a short duration of time on frequent basis except for etomidate as its adrenal suppressive action will impair the ability of the patient to mount a stress response, which this patient will need on an ongoing basis."
  },
  {
    "id": 65,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Eutectic mixture of local anesthetics (EMLA cream) is sometimes used to numb the skin before attempting an intravenous access in pediatric patients. Which of the following local anesthetics is combined with prilocaine to produce this cream?",
    "options": {
      "A": "Bupivacaine",
      "B": "Lidocaine",
      "C": "Mepivacaine",
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Epidural opioids can cause nausea, pruritus, and respiratory depression. Biggest advantage of these agents over epidural administration of local anesthetics is the hemodynamic stability, as there is no inhibition of sympathetic system. Hypotension is highly unlikely with epidural fentanyl administration."
  },
  {
    "id": 67,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following may help in mapping of a seizure focus under general anesthesia by enhancing the EEG activity or inducing the seizure?",
    "options": {
      "A": "Thiopental",
      "B": "Ketamine",
      "C": "Diazepam",
    ...
    "correctAnswer": "B",
    "explanation": "Intractable seizures are sometimes treated with excision of the seizure focus in the brain. Anesthesiologist is sometimes asked in these cases to help locate the focus through enhancing the EEG activity or actually inducing the seizure during the anesthetic. Some anesthetic agents are known to increase the seizure activity and can be utilized for that purpose. Etomidate, methohexital, older inhaled anesthetic enflurane, and, to some degree, ketamine can be helpful in this regard. Other anesthetics actually increase the seizure threshold and make it difficult for the surgeon to find the area of interest."
  },
  {
    "id": 68,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following anesthetic agents is contraindicated for use in patients with intermittent porphyria?",
    "options": {
      "A": "Ketamine",
      "B": "Etomidate",
      "C": "Isoflurane",
  ...
  },
  {
    ...
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "The minimum anesthesia concentration (MAC) of desflurane is decreased by",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "All of the drugs mentioned in the question are agonist–antagonist at different opioid receptors except naltrexone, which is a pure antagonist. Use of naltrexone in this patient who has been using heroin for such a long time will precipitate withdrawal symptoms, which include body aches, runny nose, excessive tearing and salivation, diarrhea, mood swings, and, in some cases, high blood pressure, tachycardia, and increased temperature. Severity and duration of these symptoms vary."
  },
  {
    "id": 72,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Ketamine administered in anesthetic doses",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "An acute of episode of cyanosis in a child with history of tetralogy of Fallot signifies more right-to-left shunt because of decreased systemic vascular resistance. Phenylephrine may be an appropriate agent for this situation, as it will increase the systemic vascular resistance through its action on α1 receptors, thus decreasing the shunt. As more blood flows through the lungs before returning to the heart, more oxygen will be available to the peripheral tissues improving the cyanosis. Oxygen in this situation may not be helpful as not enough of the blood is flowing through the lungs. Other options also may help treat the primary problem. Children with this condition learn to treat these episodes, called “tet spells,” by squatting down, thus increasing their systemic vascular resistance and venous return to the heart."
  },
  {
    "id": 78,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Rebound hypertension is most likely after sudden discontinuation of which of the following classes of antihypertensive drugs?",
    "options": {
    ...
    "correctAnswer": "C",
    "explanation": "Clonidine has been in clinical use for over two decades now. It is a very potent antihypertensive and is very useful to control high blood pressure in some patients with a very resistant kind of disease. Unfortunately, oral dose requires repeated doses, and omission of a dose, as will happen if a long surgical procedure was scheduled, may lead to severe rebound hypertension. Availability of transcutaneous patch has helped decrease this problem. A differential diagnosis in a patient with hypertension in the recovery room should always include possibility of rebound hypertension secondary to omission of a dose of an α agonist like clonidine. Other antihypertensive agents mentioned in the question do not lead to rebound hypertension, although hypotension during anesthesia associated with perioperative use of drugs causing angiotensin-converting enzyme blockade can be difficult to manage."
  },
  {
    "id": 79,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "A 65-year-old man has nausea and vomiting in the post–anesthesia care unit, needing antiemetic therapy. He develops involuntary facial movements, difficulty swallowing, and torticollis. Which of the following drugs is most likely to be the cause of these symptoms?",
    "options": {
    ...
    "correctAnswer": "C",
    "explanation": "Postoperative nausea and vomiting (PONV) is one of the most disliked side effects of anesthesia and surgery. Efforts to treat it sometimes lead to troublesome side effects which look alarming at the time of presentation but are easy to treat. Dystonic reactions, including tardive dyskinesia, torticollis (commonly called oculogyric crisis), dysphagia, and excessive salivation, are some of the manifestations of this pseudoparkinsonian syndrome. Butyrophenones, phenothiazines, gastrointestinal prokinetics, and lithium are some of the etiologic agents. Although promethazine can cause these reactions, the incidence is much lower than with metoclopramide. Granisetron is a 5-HT3-receptor antagonist similar to ondansetron. The 5-HT3-receptor antagonists have become the most frequently administered prophylaxis and treatment for PONV due to their efficacy. Central nervous symptoms occur in less than 8% of patients treated with this group of drugs. Intravenous diphenhydramine provides excellent relief of these neurologic symptoms."
  },
  {
    "id": 80,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following statements about ketamine is true?",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Etomidate cannot be used as an infusion because of its suppressive action on the adrenal gland; otherwise, it would be an ideal sedative agent for procedure that needs moderate sedation as it does not depress respiration even when used in induction doses. It is a potent cerebral vasoconstrictor and causes decrease in cerebral metabolism as well as cerebral blood flow. In comparison to thiopental it increases the excitatory spikes on the EEG and is a good agent for anesthesia for electroconvulsive therapy and mapping for seizure focus if EEG activity needs to be facilitated. An administered dose of etomidate is almost completely metabolized by the liver, and very little of the parent molecule is found in the urine."
  },
  {
    "id": 82,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "The MOST likely analgesic mechanism of action of gabapentin for neuropathic pain is",
    "options": {
    ...
    "correctAnswer": "D",
    "explanation": "Gabapentin has become a first-line treatment for neuropathic pain. This action is not mediated through GABA receptors as would be expected from the name. Instead, it modulates voltage-gated calcium channels which get activated in an injured nerve. Inhibition of this channel leads to decreased influx of calcium into the nerve cell, decreasing neuronal transmission responsible for causing pain. Gabapentin has not been found to interact directly with NMDA receptor. Gabapentin’s role in treatment of neuropathic pain has not been linked with any interaction with sodium channel."
  },
  {
    "id": 83,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following properties of local anesthetics is most likely a primary determinant of potency?",
    "options": {
      "A": "Vasodilation",
      "B": "pKa",
      "C": "Protein-binding",
  ...
  },
  {
    ...
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following statements about ketamine is most likely true?",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "True allergic reaction to a local anesthetic is very rare, but is more common with ester local anesthetics compared with amide local anesthetics. Procaine is the only ester local anesthetic among the choices given in this question. All others are amides. So it is probably from procaine."
  },
  {
    "id": 88,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following is most likely the (analgesic) mechanism of action of lidocaine when used for neuropathic pain?",
    "options": {
  ...
  },
  {
    ...
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "A 45-year-old farmer is brought into the emergency room. He is agitated and confused. On examination, he has dry skin with fever and rapid heart rate. Anticholinergic poisoning is suspected. Which of the following medications is most appropriate to treat his condition?",
    "options": {
      "A": "Neostigmine",
      "B": "Pyridostigmine",
      "C": "Edrophonium",
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Many physiologic factors and medications are associated with potentiation of action of neuromuscular blockers. Calcium channel blockers like verapamil lead to decreased sarcoplasmic concentration of calcium, which may potentiate the muscle weakness as well as prolong the duration of action of neuromuscular-blocking agents. Carbamazepine was originally used as anticonvulsant but has been found to be useful in many other conditions. It is not associated with prolonged action of neuromuscular-blocking agents. Many antibiotics, notably aminoglycosides, prolong the actions of these drugs, but clindamycin is safe to use and has not been shown to have any deleterious effect when used concomitantly with drugs like vecuronium."
  },
  {
    "id": 91,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "The shorter duration of action of remifentanil compared with fentanyl is primarily due to its",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Myotonia is characterized by continued involuntary contraction of a group of muscles. So once triggered, muscles fail to relax. Myotonic dystrophy is the most common form. Succinylcholine can cause severe hyperkalemia and is contraindicated in this condition. Nondepolarizing muscle relaxants may not be able to reverse this spasm. As neostigmine can also trigger myotonic episode, its use for reversal of muscle relaxants is not indicated. For that reason, it is prudent to avoid using longer-acting nondepolarizing agents that may require reversal agents. Hypothermia can trigger this condition, so precautions need to be taken to avoid it during any anesthetic. Best treatment to relieve the spasm is to inject local anesthetic into the muscle."
  },
  {
    "id": 94,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "A 50-year-old woman had cholecystectomy done under general anesthesia. Rocuronium was used as muscle relaxant, and a combination of anticholinergic and anticholinesterase was used for reversal of muscle- relaxant action. The patient is now bradycardic. The combination of reversal agents most likely to cause the bradycardia is",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Different surgical techniques are used to suture the donor heart to the cuff of the recipient heart. In any case, donor sinoatrial (SA) node is severed of its autonomic nervous system connections. As a result, all of the drugs that use SA node and normal conduction system of the heart to produce their cardiac effects fail to produce their effects in a transplanted heart. Although α1 receptors are found in the heart, their stimulation with phenylephrine is not associated with chronotropic effects. Only drugs that are able to directly stimulate the adrenergic receptors found in the myocardium are useful in treating bradycardia in a transplanted heart. Isoproterenol being a direct β1 stimulant is the drug of choice to treat an episode of bradycardia under these circumstances."
  },
  {
    "id": 99,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following statements about propofol infusion syndrome is most likely false?",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Generally, cerebral blood flow is related to cerebral metabolic rate with factors that decrease cerebral metabolic rate decrease the cerebral blood flow. This coupling effect is preserved during anesthesia, but the degree of the coupling may be altered by anesthetic agents where inhalational agents have relatively higher cerebral blood flow for any degree of cerebral metabolic rate. This variation is different for different inhalational agents and also at different doses of the same agent. At 1.5 MAC, the overall effect of desflurane is cerebral vasodilatation and increased blood flow. Although nitrous oxide has been shown to have species-specific action on cerebral vasculature, it is clear that in humans, it is a cerebral vasodilator with potential of increasing the cerebral blood flow and intracranial pressure. Phenytoin is an anticonvulsant, which has many central nervous system effects but has not been shown to be a cerebral vasodilator. Pentothal decreases cerebral metabolic rate and is known to preserve the normal coupling between the metabolism and blood flow. So administration of this agent will decrease the cerebral blood flow."
  },
  {
    "id": 101,
    "chapter": 6,
    "chapterTitle": "Anesthetic Pharmacology",
    "stem": "Which of the following classes of drugs is most likely to be responsible for an anaphylactic reaction during general anesthesia?",
    "options": {
