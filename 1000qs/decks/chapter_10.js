...
export const chapter10 = [
  {
    "id": 1,
    "chapter": 10,
    "chapterTitle": "Orthopedic Anesthesia",
    "stem": "The surgeon is performing a right total knee arthroplasty under a combined spinal–epidural anesthetic. The surgical team is providing you with information that within the next 15 minutes they plan to place bone cement (polymethylmethacrylate) to anchor the prosthesis. The most likely clinical side effect that may occur is",
    "options": {
      "A": "Hypertension",
    ...
    "correctAnswer": "C",
    "explanation": "Placement of bone cement (bone cement implantation syndrome) can result in any combination of adverse events including hypoxia, hypotension, cardiac arrhythmias (possibly heart block or even sinus arrest), pulmonary hypertension, and decreased cardiac output."
  },
  {
    "id": 2,
    "chapter": 10,
    "chapterTitle": "Orthopedic Anesthesia",
    "stem": "Potential complications of use of a pneumatic tourniquet include all of the following, except",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Advantages of neuraxial anesthesia in orthopedic surgery may include reduced incidence of DVT and PE formation, decreased platelet activity, decreased factor VIII and von Willebrand factor activity, and attenuation of stress hormone responses."
  },
  {
    "id": 5,
    "chapter": 10,
    "chapterTitle": "Orthopedic Anesthesia",
    "stem": "On postoperative day 1, an orthopedic surgeon has consulted you about his total knee arthroplasty patient who is in severe pain and has failed a regimen of patient-controlled analgesia using morphine. He is now consulting you for an epidural catheter placement for postoperative pain control, and would like to know for what time interval once-daily prophylactic low-molecular-weight heparin (LMWH) should be held prior to performing the epidural procedure:",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "According to the American Society of Regional Anesthesia and Pain Medicine anticoagulation guidelines, medications such as antiplatelet agents (Plavix, and intravenous glycoprotein IIb/IIIa inhibitors), thrombolytics, fondaparinux, direct thrombin inhibitors, or therapeutic LMWH present an unacceptable risk for spinal and/or epidural hematoma development without sufficient time lapse between administration of such medications and neuraxial techniques. Maximum administration of subcutaneous heparin of 5,000 U bid is estimated to be safe with epidural and spinal anesthesia. Heparin administration of 5,000 U tid is not known to be accepted in clinical practice in conjunction with neuraxial blockade."
  },
  {
    "id": 9,
    "chapter": 10,
    "chapterTitle": "Orthopedic Anesthesia",
    "stem": "The most correct statement regarding blood loss that may occur in a patient with a hip fracture is",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Ischemic optic neuropathy is a major cause of perioperative POVL accordingly to the vision loss registry collected by the ASA. Any increase of intraocular pressure (IOP) or decrease on mean arterial pressure (MAP) will affect ocular perfusion pressure (OPP), particularly with patients in a head-down position where edema can develop in the orbit that will increase venous pressure. OPP = MAP − IOP. CRAO accounts for a small percentage of patients who experience vision dysfunction according to the vision loss registry. CRAO may be embolic in nature or the result of direct pressure on the eyeball; therefore, it tends to be mostly unilateral."
  },
  {
    "id": 17,
    "chapter": 10,
    "chapterTitle": "Orthopedic Anesthesia",
    "stem": "After 180 minutes of tourniquet time during a difficult right total knee arthroplasty in a patient under sedation and intraoperative anesthesia provided by a combined spinal–epidural, the tourniquet is released and surgical closure is started. The patient may experience all the following subsequent to tourniquet release, except",
    "options": {
    ...
    "correctAnswer": "D",
    "explanation": "Release of a tourniquet used on an extremity during surgery is often associated with the release of metabolic (acidotic) by-products from the ischemic limb that are dumped into the systemic circulation. In patients with poor preoperative functional status or those that may experience significant intraoperative blood loss, the increased systemic metabolic by-products may be enough to result in hypotension and cardiac arrhythmia that may require volume resuscitation and/or pharmacologic support. In rare instances, the hyperkalemia may need to be treated (sodium bicarbonate or calcium)."
  },
  {
    "id": 18,
    "chapter": 10,
    "chapterTitle": "Orthopedic Anesthesia",
    "stem": "The most incorrect statement regarding placement of a femoral perineural catheter for pain management during unilateral knee replacement surgery is that a femoral nerve block when compared to neuraxial blockade",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Most of the currently used anesthetic agents may have some effects/negative influence on SSEP (differences may be minor or major changes). Several other perioperative variables such as hemoglobin concentration, temperature, CO2, and arterial blood pressure may also influence the SSEP tracing."
  },
  {
    "id": 21,
    "chapter": 10,
    "chapterTitle": "Orthopedic Anesthesia",
    "stem": "Which of the following surgical conditions may negatively influence changes on somatosensory-evoked potentials (SSEPs) wave forms?",
    "options": {
