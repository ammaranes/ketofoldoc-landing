...
export const chapter11 = [
  {
    ...
    "stem": "Which of the following is responsible for the plateau phase of cardiac action potential?",
    "options": {
    ...
    "correctAnswer": "B",
    "explanation": "The normal ventricular cell–resting membrane potential is −80 to −90 mV. Na–K ATPase bound to the membrane is responsible for concentrating K+ intracellularly and in exchange for Na and maintaining this resting- membrane potential. Action potential (depolarization) occurs when cell membrane becomes less negative and crosses a threshold value. This depolarization raises the membrane potential of the myocardial cell, sometimes as high as +20 mv. The cardiac action potential is slightly different from neuronal action potential in that it has a characteristic spike and plateau appearance. The spike portion of this action potential is produced by opening of fast sodium channels along with a decreased permeability to potassium and the plateau portion (0.2–0.3 seconds) is due to opening of slower calcium channels. After depolarization, the sodium and calcium channels close and the membrane permeability to potassium is restored. This restores the resting-membrane potential to its baseline. Spontaneously depolarizing cells, responsible for the myocardial rhythm, do so primarily by intrinsic slow leakage of calcium into cells aided by leaky Na channels moving Na+ in (Table 11-1). Table 11-1 ACTION POTENTIAL PHASE NAME NET ION MOVEMENT 0 Rapid upstroke Na+ in (relative impermeabil K+) 1 Early rapid repolarization K+ out (increased permeabili K+ transiently) 2 Plateau (a part of repolarization) Ca++ in 3 Final repolarization K+ out of cells 4 Resting-membrane potential Na+ in and K+ out"
  },
  {
    "id": 2,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "A 2-year-old boy is induced with halothane-inhalation induction. The patient suddenly gets bradycardic, and you decide to administer atropine 0.4 mg intravenously. Immediately thereafter, you notice that the patient is having a junctional tachycardia. Which of the following most accurately describes the sequence of events?",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "All anesthetic agents can depress cardiac contractility. This occurs by alterations in the intracellular concentration of calcium as follows: Inhalational agents: decreasing the entry of calcium into cells by affecting both T- and L-type calcium channels, altering the kinetics of calcium release and uptake into the sarcoplasmic reticulum, and decreasing the sensitivity of contractile proteins to calcium. These effects are more apparent with halothane than with modern inhalational agents like isoflurane, sevoflurane, and desflurane. Factors that can worsen this cardiac depression include hypocalcemia, α-adrenergic blockade, and calcium channel blockers. Nitrous oxide: reduces the intracellular calcium concentration (dose- dependent). Intravenous-induction agent ketamine: agent with no significant myocardial depression, except in critically ill patients with depleted catecholamines, where it acts as a direct myocardial depressant. Local anesthetic agents: reduce calcium influx and release in a dose- dependent fashion. Bupivacaine, tetracaine, and ropivacaine cause greater depression than lidocaine and chloroprocaine."
  },
  {
    "id": 5,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "The mechanism of “x” descent (descent between C and V waves) in the following right atrial tracing (Fig 11-1) is Figure 11-1.",
    "options": {
    ...
    "correctAnswer": "C",
    "explanation": "The CVP waveform consists of three positive waveforms called a, c, and v and two negative slopes called the x and y depressions. a wave atrial contraction c wave cusps bulging into the right atrium x descent atrial relaxation during ventricular systole v wave venous filling of the right atrium y descent atrial emptying when tricuspid valve opens"
  },
  {
    "id": 6,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "A 38-year-old healthy male volunteer is undergoing cardiac function tests as part of a physiology experiment. His vital signs are HR = 62 bpm, BP = 124/74 mm Hg, respiratory rate = 12 breaths/min, SpO2 = 100% on room air, and Hb = 14 g/dL. Which of the following is the best determination of the adequacy of his cardiac output?",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Recommended dose of heparin before initiation of cardiopulmonary bypass is 300 to 400 U/kg. The dose is given to achieve an activated clotting time of 400 to 450 seconds."
  },
  {
    "id": 10,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "The sinoatrial and the atrioventricular (AV) nodes are supplied in majority of the individuals by",
    "options": {
    ...
    "correctAnswer": "B",
    "explanation": "The SA node is supplied by the right coronary artery in 60% of individuals, and by the left anterior descending artery in 40% of the individuals. The AV node is supplied by the right coronary artery in 85% of individuals, and by the circumflex artery in 15% of individuals."
  },
  {
    "id": 11,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Baroreceptor reflex is ineffective for long-term blood pressure (BP) control because",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "The bundle of His is the only part of the cardiac conducting system, which has a dual blood supply derived from the posterior descending artery (PDA) and the left anterior descending (LAD) artery. Blood supply to the heart is from the right and left coronary arteries. The right coronary artery (RCA) normally supplies the right atrium, most of the right ventricle, and the inferior wall of the left ventricle. In 85% of persons, the PDA, which supplies part of the interventricular septum and inferior wall, arises from the RCA, and these people are said to have a right-dominant circulation. In the remaining 15% of persons, the PDA arises from the left coronary artery and is appropriately labeled left-dominant circulation. The left coronary artery normally supplies the left atrium and most of the interventricular septum and left ventricle. The left main coronary artery divides into the LAD artery and the circumflex (CX) artery. The LAD artery supplies the septum and anterior left-ventricular wall, and the CX artery supplies the lateral wall."
  },
  {
    "id": 13,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Which of the following types of myocardial work needs the highest oxygen requirement?",
    "options": {
    ...
    "correctAnswer": "C",
    "explanation": "Autoregulatory nature of the myocardium makes the myocardial oxygen demand an important determinant of myocardial blood flow. Pressure work uses most of the oxygen, 65%, followed by basal requirements = 205, volume work = 15%, with only 1% of the supplied oxygen being used for electrical activity. The myocardium also has a very high extraction ratio. It extracts 65% of the oxygen in arterial blood, compared with 25% in most other tissues. Coronary sinus oxygen saturation is usually 30%. Hence, any drop in myocardial oxygen supply is deleterious, as it cannot compensate for reduction in flow by increasing oxygen extraction. Factors influencing the supply and demand are listed in Table 11-2. Table 11-2 MYOCARDIAL OXYGEN SUPPLY MYOCARDIAL OXYGEN DEMAN Heart rate Diastolic time Aortic diastolic blood pressure Coronary perfusion pressure Ventricular end diastolic pressure Arterial oxygen content and tension Hemoglobin concentration Coronary vessel diameter Basal requirements Heart rate Wall tension Preload Afterload Contractility"
  },
  {
    "id": 14,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Which of the following inhalational agents causes the least coronary vasodilation?",
    "options": {
      "A": "Halothane",
      "B": "Isoflurane",
      "C": "Desflurane",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "According to ACC/AHA guidelines for noncardiac surgery in cardiac patients, Surgeries can be classified into high, intermediate, and low risk with high-risk surgeries having >5% risk and low-risk surgeries having <1% risk (Table 11-3). Table 11-3 Cardiac Risk Stratification for Noncardiac Surgical Procedures. High (reported cardiac risk often greater than 5%) Emergent major operations, particularly in the elderly Aortic and other major vascular surgery Peripheral vascular surgery Anticipated prolonged surgical procedures associated with large fluid shifts and/or blood loss Intermediate (reported cardiac risk generally less than 5%) Carotid endarterectomy Head and neck surgery Intraperitoneal and intrathoracic surgery Orthopedic surgery Prostate surgery Low (reported cardiac risk generally less than 1%) Endoscopic procedures Superficial procedure Cataract surgery Breast surgery"
  },
  {
    "id": 16,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "A 67-year-old patient with uncontrolled hypertension presents for an elective dialysis access creation. Which of the following techniques is not suited for attenuating the hypertensive response to intubation?",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Direct α1 agonists like phenylephrine are preferable to indirect sympathomimetics like ephedrine to treat hypotension, following induction in patients with uncontrolled hypertension preoperatively. Catecholamines —both endogenous and exogenous—can produce exaggerated hypertensive response in these patients. We can start with small doses of phenylephrine, for example, 25 to 50 μg, provided the heart rate is not too low. If the heart rate is low, small doses of ephedrine (5–10 mg) or even epinephrine (2–5 μg) may be used. In patients who are on angiotensin-receptor blocker preoperatively, the refractory hypotension may respond only to vasopressin. Avoiding high heart rates and prolonged hypertension has been shown to decrease cardiovascular morbidity."
  },
  {
    "id": 18,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Which of the following antianginal agents has the highest coronary vasodilating potential?",
    "options": {
      "A": "Nitrates",
      "B": "Verapamil",
      "C": "Dihydropyridines",
    ...
    "correctAnswer": "C",
    "explanation": "Coronary vasodilation potential of dihydropyridines (nifedipine, nicardipine, nimodipine) is much greater than those by verapamil and diltiazem. They even exceed nitrates in their vasodilatory potential. β- Blockers however have no vasodilatory action on coronary blood vessels."
  },
  {
    "id": 19,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Which of the following statements about calcium channel blockers (CCBs) is not true?",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Severe multivessel disease can be detected using exercise EKG if the patient (develops) • Cannot attain a maximum HR >70% of predicted • Dysrhythmias at a lower HR • Sustained fall in systolic blood pressure during exercise (>10 mm Hg) • ST depression >2 mm, either horizontal or down sloping • ST depression at a very low workload • ST depression sustained even after the exercise is >5 min"
  },
  {
    "id": 23,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Surgical electrocautery may cause a problem with an automated implantable cardioverter defibrillator (AICD) by all the following mechanisms, except",
    "options": {
    ...
    "correctAnswer": "D",
    "explanation": "Surgical electrocautery interference with AICDs and pacemaker devices are well known. The old adage of “put a magnet on it” is based on the fact that antitachycardia function in some (older) pacemakers was turned off by the application of a magnet. However, this is not true for most of the newer AICDs. Ideally, the manufacturer’s representative or cardiology should be contacted to find out if the device could be reprogrammed to have the antitachycardia function off prior to the surgery. This is in addition to confirming that the pacemaker was interrogated for functionality within the last year and AICD was interrogated in the last 6 months. Electrosurgical interference can be caused by the device interpreting the current as ventricular fibrillation and firing, interfering with its pacemaker capability, resetting of the device to backup mode. Some AICDs are programmed with a rate-responsive function, and this may be activated by a cautery device. If there is no time to reprogram the device prior to surgery, use of a bipolar cautery, placement of electrical return pad far away from the device, using electrocautery in small bursts are some methods to decrease such an interference. In addition, all such patients should have transcutaneous pads on and a defibrillator/pacer should be available in the room. Every effort should be made to reprogram the device to its original setting prior to discharge of the patient from the postanesthesia care unit."
  },
  {
    "id": 24,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Which of the following ECG leads is most sensitive to detect an anterior- wall myocardial ischemia?",
    "options": {
      "A": "V5",
      "B": "V4",
      "C": "II",
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "It is a common practice to cool the body to a core body temperature of 20 to 32°C following CPB start. However, it is not always required. This is based on the principle that metabolic oxygen requirements can be halved with each reduction of 10°C in body temperature. This temperature is brought back to acceptable levels (where arrhythmias are lower) at the end of CPB—a phase called rewarming. Some procedures need a complete circulatory standstill—called circulatory arrest—and deep hypothermia is employed for such procedures—cooling to 15 to 18°C allows an arrest time of around 60 minutes."
  },
  {
    "id": 26,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Adverse effects of hypothermia include all the following, except",
    "options": {
    ...
    "correctAnswer": "B",
    "explanation": "The adverse effects of hypothermia are arrhythmias, platelet dysfunction, coagulopathy, decreased systolic function of myocardium, and reduction in serum-ionized calcium due to citrate toxicity."
  },
  {
    "id": 27,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Coronary perfusion pressure is",
    "options": {
    ...
    "correctAnswer": "A",
    "explanation": "Coronary perfusion pressure is determined by the difference between the arterial diastolic pressure and the left-ventricular end diastolic pressure. The left ventricle is perfused during diastole, while the right ventricle is perfused both during diastole and systole. An increase in heart rate reduces coronary perfusion because of a shorter diastole. Normal coronary blood flow at rest is about 250 mL/min."
  },
  {
    "id": 28,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Which of the following views of transesophageal echocardiograph (TEE) is most suited to visualize blood supply of all the segments of the heart?",
    "options": {
    ...
    "correctAnswer": "C",
    "explanation": "Transgastric mid-papillary (midshort axis) view provides a snapshot of all the different blood vessels supplying the heart (Fig 11-2). Figure 11-2. Reused with permission from Shanewise JS, Shin JJ, Vezina DP, et al. Comprehensive and abbreviated intraoperative TEE examination. In: Savage RM, Aronson S, Shernan SK, eds. Comprehensive Textbook of Perioperative Transesophageal Echocardiography. 2nd ed. Philadelphia, PA: Lippincott Williams & Wilkins; 2011: 86."
  },
  {
    "id": 29,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Disadvantages of high-dose opioid induction include all the following, except",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "After initiation of CPB, pump flow is gradually increased to 2 to 2.5 L/min/m2 and MAPs are monitored. It is common to see an initial fall in BP. Initial mean systemic arterial (radial) pressures of 30 to 40 mm Hg are not unusual. Abrupt hemodilution, which reduces blood viscosity and effectively lowers systemic vascular resistance (SVR), may be responsible for this drop. The effect is partially compensated by subsequent hypothermia, which tends to raise blood viscosity again. A disastrous scenario is a persistent and excessive decrease in MAP (<30 mm Hg); transesophageal echocardiograph evaluation is very useful in such a situation to look for unrecognized aortic dissection. If dissection is present, CPB must be temporarily stopped until the aorta is recannulated distally to prevent further extension of a dissection flap with grave consequences. Poor venous return, pump malfunction, or pressure- transducer error may all cause hypotension. Aortic cannula misdirected toward the innominate artery may be a cause for false hypertension when right radial artery is used for monitoring. The relationship between pump flow, SVR, and mean systemic arterial blood pressure may be conceptualized as follows: MAP = Pump flow × SVR With a constant SVR, MAP is proportional to pump flow. Similarly, at any given pump flow, MAP is proportional to SVR. Pump flows of 2 to 2.5 L/min/m2 (50–60 mL/kg/min) and mean arterial pressures between 50 and 80 mm Hg are commonly used. Flow requirements are generally lower during deep hypothermia (20–25°C), as mean blood pressures as low as 30 mm Hg may still provide adequate cerebral blood flow. SVR can be increased with α agonists like phenylephrine. High systemic arterial pressures (>150 mm Hg) are also deleterious because they promote aortic dissection or a cerebrovascular accident in addition to increasing the surgical bleeding. Hypertension is said to exist on pump when MAPs exceed 100 mm Hg, and this is treated by decreasing pump flow or deepening anesthesia using isoflurane at the oxygenator inflow gas. Sometimes, a hypertension is refractory to these maneuvers or, if pump flow is already low, may necessitate a vasodilator like nitroprusside."
  },
  {
    "id": 34,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Which of the following is not an indication of low flow rates under cardiopulmonary bypass (CPB)?",
    "options": {
      "A": "SvO2 >80%",
    ...
    "correctAnswer": "B",
    "explanation": "Monitoring during CPB is usually done by the perfusionists. They monitor the pump flow rate, venous reservoir level, arterial inflow line pressure, blood (perfusate and venous) and myocardial temperatures, and in-line (arterial and venous) oxygen saturations. In-line pH, CO2 tension, and oxygen-tension sensors are also available in newer bypass machines. But most machines do not provide a glucose monitor, and hypoglycemia is still a threat. Blood gas tensions and pH are confirmed by direct measurements periodically—30 minute-intervals. Inadequate tissue perfusion caused by inadequate flow rates is evidenced by low venous oxygen saturations (<70%), progressive metabolic acidosis, or low urinary output, provided there is no hypoxemia. During bypass, arterial inflow line pressure is almost always higher than the systemic arterial pressure recorded from a radial artery or even an aortic catheter, caused by the pressure drop across the arterial filter, the arterial tubing, and the narrow opening of the aortic cannula."
  },
  {
    "id": 35,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Discontinuing ventilation prematurely before full flow is achieved on cardiopulmonary bypass (CPB) causes",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Epiaortic echocardiography is the most sensitive and specific technique to detect air bubbles at the termination of CPB. De-airing is facilitated by head-down position, and venting before and during initial cardiac ejection, in addition to filling up the heart with vent in place. TEE is very useful in detecting pockets of air, especially within the left ventricle. But the risk of atheromatous emboli still persists and is worse in cases where aorta was manipulated extensively, cross-clamped numerous times and in percutaneous transcatheter aortic valve replacements. Newer devices with baskets to catch such emboli have proven to be very useful."
  },
  {
    "id": 37,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Sweating during the rewarming phase of termination of cardiopulmonary bypass (CPB)",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Separation from CPB can be guided by a mnemonic: A = Airway—oxygenation and ventilation with 100% oxygen B = Blood gas—correct electrolyte abnormalities/hemoglobin C = Coagulation—reverse heparin with protamine D = Dysrhythmias—sinus rhythm is good; pacing needed sometimes (80– 100 bpm) E = Epinephrine—inotropes/vasopressors used as needed. Epinephrine may increase myocardial O2 need F = Fluids—for rapid volume resuscitation G = Good contractility by direct visualization/transesophageal echocardiogram H = Hypothermia is avoided; >37°C is aimed I = Invasive monitors recalibrated"
  },
  {
    "id": 41,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Timing of inflation of an intra-aortic balloon pump (IABP) should be",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "DDAVP, 0.3 μg/kg (intravenously over 20 minutes), can increase the activity of factors VIII and XII and the von Willebrand factor. DDAVP facilitates their release from the vascular endothelium. Hence, a second dose is usually not effective. DDAVP is very useful in reversing qualitative platelet defects, but is not recommended for routine use."
  },
  {
    "id": 46,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "In the first few postoperative hours after an open heart surgery, the emphasis is on",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "The goal during management of anesthesia for patients with hypertrophic cardiomyopathy is to decrease the pressure gradient across the left-ventricular outflow obstruction. Decreases in myocardial contractility and increases in preload (ventricular volume) and afterload will decrease the magnitude of left-ventricular outflow obstruction. Intraoperative hypotension is generally treated with intravenous fluids or an α agonist such as phenylephrine. Drugs with β-agonist activity are not likely to be used to treat hypotension because any increase in cardiac contractility or heart rate could increase left-ventricular outflow obstruction. When hypertension occurs, an increased delivered concentration of isoflurane or sevoflurane can be used. Vasodilators, such as nitroprusside or nitroglycerin, should be used with caution because decreases in systemic vascular resistance can increase left-ventricular outflow obstruction."
  },
  {
    "id": 52,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Pulmonary capillary wedge pressure (PCWP) does not correspond to the left-ventricular end diastolic pressure (LVEDP) in all of the following situations, except",
    "options": {
      "A": "Mitral stenosis",
    ...
    "correctAnswer": "B",
    "explanation": "PCWP is an indirect measure of LVEDP, with many false positives and negatives: PCWP > LVEDP • PEEP/positive-pressure ventilation • Increased intrathoracic pressure • Left-atrial pathology—myxoma • Mitral-valve pathology—stenosis/regurgitation • Pulmonary hypertension • Chronic obstructive pulmonary disease LVEDP > PCWP • LVEDP >25 mm Hg • Premature mitral-valve closure (usually an aortic regurgitation jet causing this) • Left-ventricular diastolic dysfunction (left-ventricular hypertrophy/ischemia)"
  },
  {
    "id": 53,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Normal mixed venous oxygen tension is ______ (mm Hg):",
    "options": {
      "A": "75",
      "B": "40",
      "C": "45",
    ...
    "correctAnswer": "B",
    "explanation": "Mixed venous oxygen tension refers to the oxygen tension in a venous sample with blood mixed from both inferior vena cava and superior vena cava. Ideally, this sample is drawn from the tip of a pulmonary artery catheter. It is a good measure of tissue oxygen supply relative to its demand. A reduction in delivery (decreased cardiac output) or an increase in consumption (increased BMR) can both cause a reduction in PvO2. Normal PvO2 is about 40 mm Hg, with a saturation of 75%."
  },
  {
    "id": 54,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "The only clinically proven method to reduce the risk of perioperative myocardial infarction (MI) and associated death is",
    "options": {
    ...
    "correctAnswer": "C",
    "explanation": "Site of previous MI, history of coronary artery bypass grafting, site of procedure for procedures <3 hour, and type of anesthesia used (general anesthesia vs. regional) have no influence on perioperative myocardial reinfarction. Only three pharmacologic measures have been proven to produce a decrease in cardiovascular morbidity and mortality: β-blockers, clonidine, and statins. β-Blockers started 7 to 30 days prior to surgery and continued for 30 days postoperatively reduce the risk of cardiac morbidity (MI or cardiac death) by 90%. If started just prior to surgery and continued for 7 days, it will still confer a reduction in mortality risk by 50%. Perioperative clonidine administration reduces the 30-day and 2-year mortality risks. Statin therapy with fluvastatin for 30 days before and after surgery, in addition to β-blockade, reduces risk of MI and death by an additional 50%. Intraoperatively, strict hemodynamic control using an intra-arterial catheter and prompt pharmacologic intervention or fluid infusion to treat physiologic hemodynamic alterations from the normal range may decrease the risk of perioperative cardiac morbidity in high-risk patients."
  },
  {
    "id": 55,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Which of the following statements is false regarding perioperative myocardial infarction (MI)?",
    "options": {
    ...
    "correctAnswer": "C",
    "explanation": "Perioperative risk-reduction therapy with medications is superior to risk stratification with invasive testing, angioplasty, and CABG. β-Blockers, clonidine, statin, and aspirin have all been used for this. A single 1-minute episode of myocardial ischemia detected by 1-mm ST-segment elevation or depression increases the risk of cardiac events 10-fold and the risk for death 2-fold. Tachycardia for 5 minutes above 120 bpm in the postoperative period can increase the risk of mortality 10 times. The incidence of perioperative myocardial reinfarction does not stabilize at 5% to 6% until 6 months after the prior myocardial infarction. Thus, elective surgery, especially thoracic and upper abdominal, or other major procedures used to be delayed for a period of 2 to 6 months after a myocardial infarction. However, recently this has reduced to 6 to 8 weeks following the ACC/AHA guidelines. Perioperative myocardial reinfarctions occur most frequently in the first 48 to 72 hours postoperatively. However, the risk of myocardial infarction remains increased for several months after surgery."
  },
  {
    "id": 56,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Which of the following is the most effective means of predicting a perioperative cardiac event?",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Anesthetic considerations in patients with regurgitant lesions: • Keep the heart rate high—decreases the duration of systole • Keep SVR high • Avoid decrease in myocardial contractility • V wave is a reflection of mitral-regurgitant flow"
  },
  {
    "id": 60,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Treatment of patients with prolonged QT interval include all, except",
    "options": {
      "A": "β-Blockers",
  ...
  },
  {
    ...
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Anesthetic considerations in patients with aortic stenosis include all, except",
    "options": {
    ...
    "correctAnswer": "D",
    "explanation": "Anesthetic considerations in patients with aortic stenosis: • Maintaining a high SVR • Optimal preload • Avoiding extreme fluctuations in HR (60–80 bpm is ideal) • Avoiding arrhythmias • Rapid availability of α agonists to counter the drop in SVR with induction • Accurate BP measurements preferably with an intra-arterial catheter"
  },
  {
    "id": 62,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Ventricular premature beats (VPCs) can be treated with lidocaine (1–2 mg/kg IV) when they",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "WPW syndrome is characterized by a short PR interval (less than 120 ms), a wide QRS complex, and δ wave in EKG. The short PR interval is due to conduction along the bundle of Kent, which does not have a physiologic delay like conduction across the atrioventricular node. The composite of cardiac impulses conducted by normal and accessory pathways is the reason for δ wave and wide QRS complex. WPW is the most common preexcitation syndrome, with an incidence of approximately 0.3% of the general population. Atrial arrhythmias like paroxysmal atrial tachycardia (most frequent) and supraventricular may lead to hemodynamic collapse in patients with WPW syndrome. Anesthetic management in the presence of a preexcitation syndrome is to avoid increase in sympathetic nervous system activity events (anxiety) or drugs (anticholinergics, ketamine, pancuronium) that might predispose to tachydysrhythmias. All cardiac antidysrhythmic drugs should be continued throughout the perioperative period. Ketamine with its sympathomimetic property will be a poor choice for induction. Intravenous β-blockers (atenolol, metoprolol, propranolol, or esmolol) can be used to avoid tachycardia during induction of anesthesia. Histamine-releasing agents like mivacurium/atracurium are also preferably avoided. In case of a sudden onset of tachycardia, adenosine or procainamide will be a good choice to treat the arrhythmia. Digitalis and verapamil may decrease the refractory period of accessory pathways responsible for atrial fibrillation, resulting in an increase in ventricular response rate during this dysrhythmia and should be avoided."
  },
  {
    "id": 64,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Which of the following statements is false regarding management of a patient with an automated implantable cardioverter defibrillator (AICD)?",
    "options": {
    ...
    "correctAnswer": "A",
    "explanation": "The magnet mode of many implanted devices, especially the newer AICDs, is now programmable and does not always default to asynchronous pacing. Hence, it should not be considered “safe.” The specific magnet mode for a patient’s device should be identified by interrogation prior to surgical procedures as some magnet modes change with device state or are programmable. Electrosurgical cautery is interpreted as spontaneous cardiac activity by the artificial cardiac pacemaker when the ground plate for electrocautery is placed too near the pulse generator or with use of a unipolar cautery. For this reason, the electrical return plate (wrongly called ground plate) should be placed as far as possible from the pulse generator. Other techniques to improve safety include using a bipolar cautery, and placement of external pads prior to the beginning of the case. Magnet mode for many pacemakers (not AICDs) is asynchronous at 99 bpm. However, in some devices, the magnet mode shifts to asynchronous at 50 bpm at the end of battery life. Asynchronous pacing at such a low heart rate with the sensing function off may lead to R-on-T phenomenon if the patient has a spontaneous heart rate above 50 bpm."
  },
  {
    "id": 65,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Cardiac tamponade is characterized by",
    "options": {
  ...
  },
  {
    ...
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "An 81-year-old patient with a history of moderate aortic regurgitation is undergoing a coronary artery bypass grafting (CABG). The surgeon decides not to vent the left ventricle. You think this is a wrong decision, and your arguments include all the following, except",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "In the clinical scenario described, the patient has an increased CO2 in the blood (irrespective of temperature correction). PaCO2 is a balance of CO2 production and removal. If removal exceeds production, PaCO2 decreases. If production exceeds removal, PaCO2 increases. The resulting PaCO2 is expressed by the alveolar CO2 equation: PaCO2 = k. VCO2/VA In the equation, k is a constant (0.863) that corrects units, VCO2 is carbon dioxide production, and VA is alveolar ventilation. Since the patient is on cardiopulmonary bypass, increasing the fresh-gas flow to the oxygenator will wash out more CO2. None of the other options has any role in CO2 production or elimination during cardiopulmonary bypass."
  },
  {
    "id": 69,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Two days after coronary artery bypass grafting, a 62-year-old man remains sedated, endotracheally intubated, and mechanically ventilated. Over the next 3 hours, PaO2 decreases from 90 to 70 mm Hg at an FIO2 of 0.7, peak inspiratory pressure measured proximally in the ventilator circuit increases from 40 to 66 cm H2O, and plateau pressure remains unchanged at 30 cm H2O. Which of the following is the most likely case of these changes?",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "At 30°C, the heart muscle consumes oxygen at a rate of 8 to 10 mL/100 g/min, provided it is normally contracting. Oxygen consumption in the fibrillating ventricle at 22°C is 2 mL/100 g/min. The electromechanically quiet heart at 22°C consumes oxygen at a rate of 0.3 mL/100 g/min."
  },
  {
    "id": 74,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "Additional supplemental anesthetics and muscle relaxants should be administered",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Low SVR is a very common hemodynamic abnormality after CPB. This makes weaning from CPB very difficult. SVR is usually calculated using the formula mean arterial pressure (mm Hg) − central venous pressure (mm Hg)/pump flow (L/mi) × 80. SVR should be between 1,200 and 1,400 prior to CPB separation. The units of SVR are dyn s/cm5. SVR can be normalized with a vasoconstrictor prior to weaning from CPB. By this, we are attempting to match the vascular input impedance to the cardiac output impedance and optimizing energy transfer."
  },
  {
    "id": 76,
    "chapter": 11,
    "chapterTitle": "Cardiovascular Anesthesia",
    "stem": "A 57-year-old male is undergoing coronary artery bypass grafting (left internal mammary artery to left anterior descending artery). After termination of cardiopulmonary bypass (CPB), you notice a prominent V wave in the pulmonary artery occlusion pressure (PAOP) tracing. The most likely reason for the finding is",
    "options": {
