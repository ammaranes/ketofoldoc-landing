...
export const chapter12 = [
  {
    ...
    "stem": "Which of the following is not a characteristic feature of asthma?",
    "options": {
    ...
    "correctAnswer": "D",
    "explanation": "Asthma is a type of reactive airway disease characterized by hyperresponsive airways, reversible expiratory airflow obstruction, and chronic inflammation. Sudden bronchospasm in response to external/internal stimuli and response to bronchodilators like β2-agonists are important distinguishing features of asthma. Elastase deficiency in the airways is a feature of emphysema."
  },
  {
    "id": 2,
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "A 55-year-old male presented to you with a pulmonary function test report, which shows an increase of FEV1 percent predicted of more than 12%, and an increase in FEV1 of greater than 0.2 L in response to bronchodilators. Which characteristic of his respiratory illness is depicted here?",
    "options": {
    ...
    "correctAnswer": "A",
    "explanation": "Response to a bronchodilator drug resulting in relief of airway obstruction is highly suggestive of bronchial asthma. A more than 12% increase in predicted FEV1 and an absolute increase in FEV1 of more than 0.2 L suggest acute bronchodilator responsiveness and variability in airflow obstruction. The reversibility of this magnitude is almost always indicative of bronchial asthma. COPD patients do respond to bronchodilators but not to the same extent. Early stages of asthma are diagnosed by decreased mid expiratory flow rates (effort independent) and decreased FEV1 and by its reversibility."
  },
  {
    "id": 3,
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "Which of the following techniques is associated with a lower complication rate related to bronchospasm in the asthmatic population?",
    "options": {
  ...
  },
  {
    ...
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "Anesthetic considerations for a patient with severe pulmonary hypertension include all the following, except",
    "options": {
    ...
    "correctAnswer": "B",
    "explanation": "Pulmonary hypertension is defined as an increase in mean pulmonary artery pressure above 25 mm Hg at rest or 30 mm Hg with exercise in the presence or absence of an elevated pulmonary capillary wedge pressure. Right-sided heart catheterization is the gold standard for diagnosing and quantifying the degree of pulmonary hypertension. Care should be taken to avoid all the factors that increase pulmonary vascular resistance in a patient with severe pulmonary hypertension presenting for surgery. This includes avoiding hypoxia, hypercarbia, hypothermia, light anesthesia, pain, dysrhythmias, and maintaining adequate cardiac output. Progressive right- ventricular dilation and hypertrophy in response to an increased afterload generated by chronic pulmonary hypertension will eventually lead to right- ventricular systolic dysfunction, inadequate left-ventricular filling, and eventually biventricular failure. The interventricular septal bulge decreases left-ventricular cavity filling, further worsening the left-ventricular failure. Cardiac output from a failing right ventricle depends on the filling pressure from venous return and pulmonary pressure. Pulmonary hypertension in pregnant patients has a high mortality rate up to 50% for vaginal delivery and even higher for cesarean delivery."
  },
  {
    "id": 9,
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "Which of the following is not a part of the “STOP BANG” screening questionnaire for obstructive sleep apnea (OSA)?",
    "options": {
      "A": "Snoring",
      "B": "Observed apnea",
    ...
    "correctAnswer": "C",
    "explanation": "Snoring, daytime sleepiness, hypertension, obesity, and a family history of OSA are risk factors for OSA. There is a high risk for OSA if >3 yes to the below questions. S (snore) Have you been told that you snore? T (tired) Are you often tired during the day? O (obstruction) Do you know if you stop breathing or has anyone witnessed you stop breathing while you are asleep? P (pressure) Do you have high blood pressure or on medication to control high blood pressure? B (BMI) Is your body mass index greater than 28? A (age) Are you 50 years old or older? N (neck) Are you a male with a neck circumference greater than 17 inches, or a female with a neck circumference greater than 16 inches. G (gender) Are you a male?"
  },
  {
    "id": 10,
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "Risk factors associated with increased perioperative morbidity and mortality in thoracic surgery patients include all the following, except",
    "options": {
  ...
  },
  {
    ...
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "In surgical cases requiring lung isolation",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Figure 12-4A is a bronchial blocker for a left-sided lung surgery placed deeply into the left main-stem bronchus. Figure 12-4B is a bronchial blocker advanced too far into the right main stem, and the balloon of the bronchial blocker is occluding the right upper lobe takeoff. For both situations, the bronchial blocker should be withdrawn a couple of centimeters to a level just below the carina. Figure 12-4. Figure 12-4."
  },
  {
    "id": 16,
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "In which of the following situations is applying continuous positive-airway pressure (CPAP) to the nondependent lung most ideal for improving oxygenation?",
    "options": {
  ...
  },
  {
    ...
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "In an open pneumothorax, the major effect of mediastinal shift is to",
    "options": {
  ...
  },
  {
    ...
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "Factors known to inhibit hypoxic pulmonary vasoconstriction (HPV) and thus worsen the alveolar–arterial oxygen gradient include all of the following, except",
    "options": {
      "A": "Hypocapnia",
      "B": "Nitroglycerin",
      "C": "Hypercapnia",
  ...
  },
  {
    ...
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "A bronchial blocker is useful in all of the following clinical situations, except",
    "options": {
  ...
  },
  {
    ...
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "Regarding lung resection surgery, which of the following statements is false?",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Apneic oxygenation refers to insufflation of 100% oxygen at a rate greater than the oxygen consumption (>250 mL/min) while the ventilation is stopped. Progressive respiratory acidosis limits the use of this technique to 10 to 20 minutes in most patients. Oxygenation can be maintained in patients with normal DLCO for more than this time interval. During apneic oxygenation, arterial PCO2 rises 6 mm Hg in the first minute followed by 3 to 4 mm Hg every subsequent minute."
  },
  {
    "id": 28,
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "A 68-year-old male patient with a lung nodule underwent a right upper lobectomy. On postoperative day 4, the patient develops a sudden large air leak from the chest tube associated with increasing pneumothorax and partial lung collapse. The most likely cause is",
    "options": {
  ...
  },
  {
    ...
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "Complications associated with mediastinoscopy include all the following, except",
    "options": {
  ...
  },
  {
    ...
    "chapter": 12,
    "chapterTitle": "Thoracic Anesthesia",
    "stem": "After a double-lung transplantation",
    "options": {
