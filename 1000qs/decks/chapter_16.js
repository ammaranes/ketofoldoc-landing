...
export const chapter16 = [
  {
    ...
    "stem": "The most accurate statement regarding absorption of topically administered ophthalmic drugs is that they are absorbed",
    "options": {
    ...
    "correctAnswer": "D",
    "explanation": "Topically applied drops are quickly absorbed by the mucosal lining of the nasolacrimal duct as well as by blood vessels in the conjunctival sac with a potential to produce systemic effects. Absorption is rapid, faster than oral or subcutaneous administration, but still slower than intravenous."
  },
  {
    "id": 2,
    "chapter": 16,
    "chapterTitle": "Ophthalmic, Ear, Nose, and Throat Surgery",
    "stem": "Drainage of aqueous humor occurs at all of these sites, except",
    "options": {
      "A": "Canal of Schlemm",
    ...
    "correctAnswer": "D",
    "explanation": "Intraocular pressure (IOP) is a reflection of the eye’s ability to form and drain aqueous humor. The posterior chamber’s ciliary body is the major producer of aqueous humor. Obstruction of the drainage system, whether it is at the canal of Schlemm, the trabecular network, or the episcleral venous system, will elevate IOP. Tear ducts do not contribute to the drainage of aqueous humor."
  },
  {
    "id": 3,
    "chapter": 16,
    "chapterTitle": "Ophthalmic, Ear, Nose, and Throat Surgery",
    "stem": "The normal intraocular pressure (IOP) is _______ (mm Hg):",
    "options": {
      "A": "5",
      "B": "10",
      "C": "25",
    ...
    "correctAnswer": "B",
    "explanation": "Normally, IOP of the eye varies between 10 and 22 mm Hg, and is generally considered abnormal when >25 mm Hg. This pressure is not static, as it can vary by 1 to 2 mm Hg with each cardiac contraction. Diurnal variations of up to 5 mm Hg also exist, with a higher pressure noted upon awakening."
  },
  {
    "id": 4,
    "chapter": 16,
    "chapterTitle": "Ophthalmic, Ear, Nose, and Throat Surgery",
    "stem": "Correct consequence of respiratory variables on intraocular pressure (IOP) is",
    "options": {
    ...
    "correctAnswer": "D",
    "explanation": "Hypoventilation (↑PaCO2) along with hypoxemia (↓PaO2) will result in increased IOP, whereas hyperventilation (↓PaCO2) will serve to minimize choroidal blood flow to decrease IOP. Hyperoxemia (↑PaO2) does not affect IOP significantly."
  },
  {
    "id": 5,
    "chapter": 16,
    "chapterTitle": "Ophthalmic, Ear, Nose, and Throat Surgery",
    "stem": "All of the following will serve to decrease intraocular pressure (IOP), except",
    "options": {
      "A": "Nitrous oxide",
      "B": "Acidosis",
      "C": "Morphine",
    ...
    "correctAnswer": "B",
    "explanation": "Inhaled and injected anesthetics (with the exception of ketamine) along with opioids tend to lower IOP. Nondepolarizing muscle relaxants will decrease IOP, presumably via their relaxant effects on extraocular muscles. Hypoventilation (↑PaCO2) results in respiratory acidosis, which will increase IOP (Table 16-2). Table 16-2 Factors Affecting Intraocular Pressure (IOP) Increased IOP • Hypertension (sympathetic stimulation) as occurs durin laryngoscopy and intubation • Acidosis • Hypoxia • Increased central venous pressure (coughing, valsalva maneuver) Decreased IOP • Hypotension • Inhalational anesthetics (volatile and nitrous oxide) • Opioids • Nondepolarizing muscle relaxants Table 16-3 Signs of Malignant Hyperthermia Early Late Increased EtCO2 Hyperthermia Tachycardia Elevated creatine phosphokinase Skeletal muscle spasm/rigidity Myoglobinuria Tachypnea Cyanosis Sweating Disseminated intravascular coagulation Acidosis—respiratory and metabolic Cardiac arrest"
  },
  {
    "id": 6,
    "chapter": 16,
    "chapterTitle": "Ophthalmic, Ear, Nose, and Throat Surgery",
    "stem": "Increases in intraocular pressure (IOP) following succinylcholine administration for tracheal intubation can be minimized by all of the following, except",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "The afferent limb of the oculocardiac reflex is the trigeminal nerve such that triggers include pressure on the globe, conjunctiva, or orbital structures as well as traction of the extraocular muscles. The vagus nerve is the efferent limb with connections to the sinoatrial node triggering a reflex bradycardia. The optic nerve is not involved in this reflex activity."
  },
  {
    "id": 17,
    "chapter": 16,
    "chapterTitle": "Ophthalmic, Ear, Nose, and Throat Surgery",
    "stem": "Appropriate anesthetic management for ophthalmic surgery requires tight control of intraocular pressure (IOP) before, during, and after the procedure. The accurate effect of an anesthetic drug or maneuver on IOP is",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Nerves blocked are those within the optic cone (annulus of Zinn), which include optic (CN II), oculomotor (CN III), and the abducens (CN VI). The trochlear nerve (CN IV) is not affected, since it is located outside of this muscle cone."
  },
  {
    "id": 19,
    "chapter": 16,
    "chapterTitle": "Ophthalmic, Ear, Nose, and Throat Surgery",
    "stem": "The eye movement that is preserved, or unaffected, following a retrobulbar block with 0.5% bupivacaine is",
    "options": {
      "A": "Abduction",
      "B": "Rotation",
      "C": "Adduction",
    ...
    "correctAnswer": "B",
    "explanation": "The trochlear nerve (CN IV) remains intact following a retrobulbar block, since it is located outside of the muscle cone. The trochlear nerve innervates the superior oblique muscle; thus, rotational movement of the eye remains intact."
  },
  {
    "id": 20,
    "chapter": 16,
    "chapterTitle": "Ophthalmic, Ear, Nose, and Throat Surgery",
    "stem": "Possible complications of a retrobulbar block include all the following, except",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Blockade of the orbicularis oculi muscle, which is a sphincter muscle around the eye, can further provide adequate surgical conditions for any ocular procedure with consequent inability to squeeze the lids shut. This can be achieved by blockade of the facial nerve (CN VII)."
  },
  {
    "id": 22,
    "chapter": 16,
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Hyperventilation, hypotension, and hypothermia decrease IOP, whereas arterial hypoxemia and hypoventilation elevate IOP. External pressure can also be generated by venous congestion of orbital veins, which is accentuated during a valsalva, coughing, and vomiting. Additionally, most inhaled and injected anesthetics (with the exception of ketamine) can also serve to reduce IOP."
  },
  {
    "id": 25,
    "chapter": 16,
    ...
    "correctAnswer": "C",
    "explanation": "The oculocardiac reflex best explains this cardiovascular presentation during ophthalmologic surgeries. First-line therapy is always to remove the stimulus, which is mediated via trigeminal afferents."
  },
  {
    "id": 26,
    "chapter": 16,
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Post airway fires, it is most appropriate to leave the patient intubated for continued observation as the presence of laryngeal and pharyngeal edema can result in failed extubation. Therefore, this patient should be reintubated with a regular endotracheal tube and monitored for the next 24 hours. Corticosteroids can be considered for severe edema with absent cuff leak, but generally is not given prophylactically."
  },
  {
    "id": 36,
    "chapter": 16,
    "chapterTitle": "Ophthalmic, Ear, Nose, and Throat Surgery",
    "stem": "A 10-year-old girl with hoarseness presents for laser microsurgery to address laryngeal papillomas. She is otherwise healthy. The surgeon is requesting a general endotracheal anesthetic (GETA). The gas mixture least likely to support combustion is",
    "options": {
      "A": "Oxygen 35%, air 65%",
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "The configuration of the flow–volume curve during spirometry testing can be used to demonstrate abnormalities of the larger central airways (larynx, trachea, and main stem bronchi). The FEV1/FVC ratio can provide diagnostic value, as disproportionate reduction in the FEV1 as compared to the FVC is the hallmark of obstructive lung diseases. Concern should be made regarding airway collapse following sedation or induction of anesthesia when extrathoracic lesions are present. If long-standing, tracheomalacia may leave the trachea weak and collapsible postoperatively (Fig 16-3). Figure 16-3."
  },
  {
    "id": 40,
    "chapter": 16,
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Inspection of the neck is generally considered the first step, as it may reveal a life-threatening and reversible cause of airway obstruction such as a compressing hematoma. Direct visualization of vocal cords may point toward recurrent laryngeal nerve damage contributing to dyspnea. Though hypocalcemia due to removal of the parathyroid glands can occur, signs and symptoms will usually present much later in the perioperative course (24– 96 hours), and unlikely to be contributing to dyspnea in the PACU. Inhaled racemic epinephrine is commonly used when stridor is present after extubation."
  },
  {
    "id": 42,
    "chapter": 16,
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Increasing EtCO2 and temperature may reveal possible malignant hyperthermia. With onset of cardiac arrhythmias, and the increasing likelihood of the development of malignant hyperthermia with rapidly climbing EtCO2 and hyperthermia, treatment with dantrolene should be considered and pursued. Other signs that can strengthen the diagnosis are muscle rigidity and myoglobinuria."
  },
  {
    "id": 47,
    "chapter": 16,
