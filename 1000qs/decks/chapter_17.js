...
export const chapter17 = [
  {
    ...
    "stem": "Beyond midgestation, pregnant women are at increased risk of gastroesophageal reflux and aspiration of gastric contents for all these reasons, except",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "During pregnancy, cardiovascular changes include increase in blood volume, plasma volume, cardiac output, stroke volume, and heart rate. Despite these increases, the systemic blood pressure, during a normal uncomplicated pregnancy, does not increase due to decrease in systemic vascular resistance. Similarly, there is no change in central venous pressures despite the increase in plasma volume due to increase in venous capacitance (Table 17-1). Table 17-1 Normal Hemodynamic Changes during Pregnancy Parameter Pregnancy Labor Blood volume Increase of 50% Increase Heart rate Increase of 10–15 bpm Increase Blood pressure Decrease of 10 mm Hg Increase Stroke volume Increase—1st and 2nd trimester Decrease—3rd trimester Increase of 300 mL/contraction Cardiac output Increase of 30%–50% Additional increase of 50% Systemic vascular resistance Decrease Increase"
  },
  {
    "id": 3,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "During pregnancy, the disproportionate increase in plasma volume versus erythrocyte volume accounts for",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Cardiac output in the third trimester is increased by nearly 50% due to an increase in both the stroke volume and heart rate to meet augmented maternal and fetal metabolic demands."
  },
  {
    "id": 5,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "The largest increase in cardiac output is seen during this peripartum period:",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Decreased functional residual capacity (FRC) with increased minute ventilation results in an escalation in rate at which changes of alveolar concentration of inhaled anesthetics can be achieved, increasing speed of induction, emergence, and changes in depth of anesthesia."
  },
  {
    "id": 14,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "When providing general anesthesia during pregnancy, minimum alveolar concentration (MAC) is",
    "options": {
      "A": "Increased",
      "B": "Decreased",
      "C": "Unchanged",
    ...
    "correctAnswer": "B",
    "explanation": "MAC progressively decreases during pregnancy—at term by as much as 40%—for all volatile anesthetic agents."
  },
  {
    "id": 15,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "The speed of time to hypoxia following apnea is faster in the late-trimester parturient due to all of the following factors, except",
    "options": {
    ...
    "correctAnswer": "C",
    "explanation": "Increased oxygen consumption and decreased reserve due to reduced functional residual capacity can result in a rapid fall in arterial oxygen tension during apnea. This occurs despite careful preoxygenation, which importantly provides a time buffer."
  },
  {
    "id": 16,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "The correct respiratory physiologic change associated with pregnancy is",
    "options": {
    ...
    "correctAnswer": "D",
    "explanation": "Minute ventilation is increased above prepregnant levels primarily by a significant increase in tidal volume with smaller increases in respiratory rate. Resting maternal PaCO2 decreases from 40 to about 32 mm Hg, though arterial pH approaches normal levels with increased renal excretion of bicarbonate ions. At term, PaO2 generally does not change significantly, though may be slightly decreased, reflecting airway closure and atelectasis."
  },
  {
    "id": 17,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "The P50 for maternal hemoglobin",
    "options": {
    ...
    "correctAnswer": "A",
    "explanation": "Elevated levels of 2,3-DPG decreases maternal hemoglobin affinity for oxygen, shifting the P50 curve to the right (increasing it from 27 to 30 mm Hg) to enhance oxygen delivery to tissues."
  },
  {
    "id": 18,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "At sea level, the most likely arterial blood gas (ABG) sample of a parturient at 35 weeks’ gestation when she rests in the supine position breathing room air is",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "The Apgar is a scoring system for evaluating an infant’s physical condition at birth. The infant’s heart rate (1 pt), respiration (1 pt), muscle tone (0 pt), response to stimuli (1 pt), and color (0 pt) are rated at 1 minute and again at 5 minutes after birth. Each factor is scored 0, 1, or 2; the maximum total score is 10 (Fig 17-3). Figure 17-3."
  },
  {
    "id": 25,
    "chapter": 17,
    ...
    "correctAnswer": "C",
    "explanation": "A team that is skilled at reviving newborn infants should be at the delivery if meconium staining is found in the amniotic fluid. Newborns should be placed under radiant heat sources to support body temperature, as heat loss can be rapid. If the baby is active and crying, no treatment is needed. If the baby is not active and crying right after delivery, the trachea should be suctioned. Avoiding positive-pressure ventilation before suctioning can minimize further aspiration into the lungs."
  },
  {
    "id": 26,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "Regarding forceps-assisted delivery",
    "options": {
    ...
    "correctAnswer": "D",
    "explanation": "The invention of the forceps has had a profound influence on obstetrics, providing an alternative modality to surgical delivery during cases of difficult, nonprogressing, or obstructed labor. High-forceps delivery refers to attempted delivery prior to head engagement, which carries high risk and is no longer an accepted practice. Certainly, there is risk to both mother and child. Maternal risks include increased postpartum recovery time and pain, while in the fetus, forceps assistance can cause minor injuries such as cuts and bruises, or more serious damages such as facial nerve injury, clavicle fracture, and intracranial hemorrhage."
  },
  {
    "id": 27,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "True statement regarding fetal circulation includes",
    "options": {
    ...
    "correctAnswer": "D",
    "explanation": "The fetal circulation is markedly different from the adult circulation as gas exchange does not occur in the lungs but instead occurs in the placenta. The placenta provides oxygen-rich blood via the umbilical vein to the fetal circulation and removes deoxygenated blood via umbilical arteries. In addition, the fetal cardiovascular system is designed in such a way that the most highly oxygenated blood is delivered preferentially to vital organs (brain and heart) while minimizing flow to nonvital fetal organs (liver and lungs). The presence of intra- and extracardiac shunts achieves these circulatory adaptations in the fetus; the ductus venosus shunts oxygenated blood away from the liver, while the ductus arteriosus shunts blood away from the fetal pulmonary bed. The foramen ovale effectively shunts blood from the right to the left atrium, resulting in equalization of right and left sides of the heart (Fig 17-4). Figure 17-4."
  },
  {
    "id": 28,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "Successful transition from fetal to neonatal circulation is required after birth to support extrauterine life. This depends primarily on these factors, except",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Placental exchange of substances occurs principally by diffusion from the maternal circulation to the fetus and vice versa, which depends on maternal–fetal concentration gradients, maternal protein-binding, molecular weight, lipid solubility, and the degree of ionization of that substance."
  },
  {
    "id": 30,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "Which of the following best explains why lidocaine has a higher fetal-to- maternal plasma ratio when compared with bupivacaine?",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Epidural abscesses are associated with headache, fevers/chills, nausea/vomiting, low back pain, and bowel or bladder dysfunction that can range from retention to incontinence. Hematologic evaluation would likely reveal an immune response with elevated WBC."
  },
  {
    "id": 40,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "Postdural puncture headache (PDPH) occurs more frequently",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "B",
    "explanation": "Magnesium acts as a physiologic calcium blocker to provide uterine relaxation in addition to electrical conduction disruption such that levels can be predicted strength of deep-tendon reflexes. Similarly, postsuccinylcholine fasciculations are blunted."
  },
  {
    "id": 42,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "Administration of all the following will provide uterine relaxation, except",
    "options": {
      "A": "Sevoflurane",
      "B": "Nitrous oxide",
      "C": "Nitroglycerine",
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Maternal side effects due to β2-agonist therapy (e.g., terbutaline, ritodrine) for tocolysis include cardiopulmonary complications (e.g., arrhythmias, tachycardia, hypotension, and pulmonary edema) and metabolic hyperglycemia."
  },
  {
    "id": 44,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "During a general anesthetic for emergent cesarean section, administering of all of the following could contribute to increased operative blood loss, except",
    "options": {
      "A": "Nitroglycerine",
    ...
    "correctAnswer": "D",
    "explanation": "Alkalization of the blood causes vasoconstriction, to provide a semblance of hemostasis. Inhaled anesthetics, ritodrine, and nitroglycerine are all potent vasodilators that can contribute to her ongoing blood loss."
  },
  {
    "id": 45,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "With regard to sodium thiopental, the following statements are accurate, except",
    "options": {
  ...
  },
  {
    ...
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "The following statements are true regarding umbilical cord blood, except",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "The fetal heart rate varies beat to beat, with a normal heart rate ranging between 110 and 160 bpm. This normal variability is thought to reflect the integrity of the vagal neural pathway from the fetal cerebral cortex to the cardiac conduction system. Fetal well-being is safeguarded when this beat- to-beat variability is present. Conversely, fetal distress is associated with minimal (or absent) variability of the fetal heart rate. Opioids, benzodiazepines, sedative-hypnotics, local anesthetics, phenothiazines, and anticholinergics administered to the mother have been shown to eliminate or reduce this variability, even in the absence of distress. This drug-related effect does not appear to be deleterious, but may cause difficulty in interpreting fetal heart rate monitors."
  },
  {
    "id": 48,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "A 24-year-old G4P2 parturient is undergoing a general anesthetic for emergency cesarean section due to uterine rupture. All these findings would suggest an amniotic fluid embolism (AFE), except",
    "options": {
      "A": "Decreased EtCO2",
  ...
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Glycopyrrolate, insulin, heparin, and neuromuscular blockers are unable to cross the placenta, whereas opioids, local anesthetics, atropine, ephedrine, and β-blockers readily cross the placenta to enter the neonatal circulation."
  },
  {
    "id": 53,
    "chapter": 17,
    "chapterTitle": "Obstetric Anesthesia",
    "stem": "Following a 0.6 mg/kg intravenous dose of rocuronium to facilitate rapid- sequence induction in a parturient requiring surgical delivery, one would expect",
    "options": {
  ...
  },
  {
    ...
    "correctAnswer": "A",
    "explanation": "Overdose of magnesium during the peripartum period can lead to arreflexia and cardiac conduction abnormalities, resulting in bradycardia and ectopy. Metabolic acidosis would be seen in cases of severe hypovolemic shock. Examination findings expected with hypocalcemia would include hyperreflexia, as opposed to arreflexia."
  },
  {
    "id": 58,
    "chapter": 17,
